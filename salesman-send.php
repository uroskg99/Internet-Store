...
<div id="popup" class="hide">
    ...
    if($res == 0){
        ...
        <div class="buttons">
            <?php echo "<a href='submit-product-check.php?name=".$product_data['name']."'>"; ?>
            <button class="search-button" type="submit" onclick='return submitProduct()'>Potvrdi</button>
            <?php echo "</a>"; ?>
            <?php echo "<a href='cancel-product-check.php?name=".$product_data['name']."'>"; ?>
            <button class="search-button1" type="submit" onclick='return cancelProduct()'>Otkaži</button>
            <?php echo "</a>"; ?>
        </div>
